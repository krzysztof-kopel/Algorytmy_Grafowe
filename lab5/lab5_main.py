...
from lab5.algorithms import is_chordal, max_clique, coloring, min_vcover
...
compare_algorithms([is_chordal, max_clique, coloring, min_vcover], ["sprawdzania, czy graf jest przekątniowy", "wyznacza rozmiaru największej kliki",
                                                        "wyznaczania liczby chromatycznej", "znajdowania rozmiaru najmniejszego pokrycia wierzchołkowego"], graph)
