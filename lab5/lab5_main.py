...
from lab5.algorithms import is_chordal, max_clique, coloring
...
compare_algorithms([is_chordal, max_clique, coloring], ["sprawdzania, czy graf jest przekątniowy", "wyznacza rozmiaru największej kliki",
                                                        "wyznaczania liczby chromatycznej"], graph)
